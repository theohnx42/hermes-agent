...
async def get_session_messages(
    ...
    def _read():
        ...
        try:
            ...
            page_offset = max(0, total - _limit) if tail and _limit is not None else max(0, offset)
            return sid, _limit, page_offset, total, db.get_messages(sid, limit=_limit, offset=page_offset)
        finally:
            db.close()
